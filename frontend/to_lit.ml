...
let rec lit_of_expr expr =
  ...
  | Pexp_constraint _ -> _failatwith __FILE__ __LINE__ "die"
  ...
  | Pexp_let _ -> _failatwith __FILE__ __LINE__ "die"
  | Pexp_apply (func, args) ->
      ...
      in
      res
  | Pexp_ifthenelse _ -> _failatwith __FILE__ __LINE__ "die"
  | Pexp_match _ -> _failatwith __FILE__ __LINE__ "die"
  | Pexp_fun _ -> _failatwith __FILE__ __LINE__ "die"
  | Pexp_sequence _ -> _failatwith __FILE__ __LINE__ "die"
  | _ ->
      raise
      @@ failwith
